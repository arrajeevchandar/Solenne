  ...
  Future<List<CameraDescription>> availableCameras() async {
    try {
      ...
      for (final videoInputDevice in videoInputDevices) {
        ...
        } on CameraWebException catch (error) {
          // Chrome may enumerate an installed virtual camera even when its
          // provider is not running. That device must not prevent healthy
          // physical cameras from being discovered and initialized.
          if (error.code != CameraErrorCode.notReadable) rethrow;
        }
